...
############################################
##  There are several things that copied  ##
###### from another game saw on youtube ####
############################################
############################################
############################################
...
crashed = False
carImg = pygame.image.load(r'pics\mainC.png')
goodImg = [pygame.image.load(r'pics\o1.png'), pygame.image.load(r'pics\o2.png')]
badImg = pygame.image.load(r'pics\o3.png')
bg = pygame.image.load(r'pics\bg3.png')
bg_ball = pygame.image.load(r'pics\bg_ball.png')
introImg = pygame.image.load(r'pics\intro.jpg')
bg_level1 = pygame.image.load(r'pics\forest.png')
hole_mom = pygame.image.load(r'pics\mom_hole.png')
hole_gm1 = pygame.image.load(r'pics\grand_hole1.png')
hole_gm2 = pygame.image.load(r'pics\grand_hole2.png')
ball = pygame.image.load(r'pics\ball.png')
super_dad = pygame.image.load(r'pics\super_dad.png')
dad = pygame.image.load(r'pics\dad.png')
pishoto = pygame.image.load(r'pics\pishoto.png')
strong_pishoto = pygame.image.load(r'pics\strongpishoto.png')
strong_pishoto2 = pygame.image.load(r'pics\strongpishoto2.png')
...
def video_play(file_name, start_frame, next_level):
    ...
    while not crashed:
        ...
        for i in range(0, 10):
            if x_range[i] - 10 < x_ball < x_range[i] + obj_width + 30 and y_range[i] - obj_height - 30 < y_ball < \
                ...
                winsound.PlaySound(r'sounds\shvetz_tit_sound.wav', winsound.SND_ASYNC)
...
def level_2(points=0):
    if points == -2:
        ...
        # pygame.mixer.music.play()
        winsound.PlaySound(r'sounds\shvetz_1_sound.wav', winsound.SND_ASYNC)
            ...
            if points < 5:
                if event.type == pygame.MOUSEBUTTONDOWN:
                    if char0.collidepoint(pygame.mouse.get_pos()[0], pygame.mouse.get_pos()[1]):
                        ...
                        # pygame.mixer.music.play()
                        winsound.PlaySound(r'sounds\shvetz_1_sound_kill.wav', winsound.SND_ASYNC)
                        points += 1
                        level_2(points)
        ...
        for i in range(0, 10):
            if x_range[i] - 20 < x < x_range[i] + obj_width + 20 and y_range[i] - obj_height - 20 < y < y_range[i] \
                ...
                if i == 4:
                    ...
                    # pygame.mixer.music.play()
                    winsound.PlaySound(r'sounds\shvetz_mural.wav', winsound.SND_ASYNC)
...
def intro(level):
    if level == 0:
        winsound.PlaySound(r'sounds\shvetz_intro_sound.wav', winsound.SND_ASYNC)
    ...
    if level == 6:
        ...
        # pygame.mixer.music.play()
        winsound.PlaySound(r'sounds\shvetz_bat.wav', winsound.SND_ASYNC)
    while level == 0:
    ...
    while level == 1:  # סרטון מעבר
        video_play(r'clips\Shvetz_1.mp4', 0, 2)

    while level == 2:  # להרוג את סבתא
        level_2(-2)

    while level == 3:  # סרטון מעבר - השתלטות על השרביט
        video_play(r'clips\Shvetz_2.mp4', 0, 4)
    ...
    while level == 5:  # סרטון כלשהו
        video_play(r'clips\Shvetz_tit.mp4', 0, 6)
    ...
    while level == 7:  # סרטון קובה
        video_play(r'clips\Shvetz_kube.mp4', 1, 8)
